    ...
    <div id="keto" className="relative mx-auto flex w-full flex-col items-center justify-center py-6 px-2 text-center ">
      <div className="mt-8">
        ...
        <div className="mx-auto max-w-4xl pb-4 text-xl leading-snug">
          ...
          <p className="py-2">
            En la cetosis, nuestro cuerpo quema grasa para obtener energía en lugar de azúcar.
            Algunas partes de nuestro cuerpo, como nuestro cerebro, solo pueden utilizar el azúcar
            en sangre como fuente de energía. Con una dieta muy baja en carbohidratos, nuestro
            hígado comienza a crear compuestos conocidos como cuerpos cetónicos para suministrar la
            energía necesaria a estas células dependientes de la glucosa.
          </p>
          <p className="py-2">
            ...
            mayoría, esto significa que del 5% al ​​10% de la ingesta energética total puede
