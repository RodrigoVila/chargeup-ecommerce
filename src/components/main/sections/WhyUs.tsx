...
const WhyUsSection = () => {
  return (
    <div className="relative mx-auto w-full bg-purple-400 h-full min-h-screeng py-6 text-center text-3xl text-white">
      <div className="w-30">
        <div className="w-full py-10 text-center text-8xl ">¿Por qué elegirnos?</div>
