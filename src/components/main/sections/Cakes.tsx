...
const CakesSection: FC = () => {
  return ( // bg-fixed bg-center bg-no-repeat  bg-[url('/wooden.jpg')] bg-cover
    <div className="relative m-auto flex h-full md:h-screen w-full flex-col items-center justify-center bg-[url('/cake.webp')] bg-fixed bg-cover bg-center bg-no-repeat text-white">
