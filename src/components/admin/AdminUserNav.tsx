        ...
        <div className="max-w-xl mx-auto px-2 sm:px-6 lg:px-8">
          <div className="relative flex items-center justify-between h-16">
            ...
            <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
              ...
              {/* Profile dropdown */}
              <Menu as="div" className="ml-3 relative bg-gray-800 ">
                <div>
                  <Menu.Button className="text-lime-200 bg-stone-500 flex text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white">
                    <span className="sr-only decoration-gray-200 hover:text-lime-200">Open user menu</span>
                    <img
