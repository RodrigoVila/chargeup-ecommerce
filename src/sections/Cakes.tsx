...
const CakesSection: FC = () => {
  return (
    <Section id="cakes" title="Cakes" bgImage="cake.jpg" overlay>
      ...
      <p className="py-2">
        Hemos seleccionado estas dos opciones ya que el banana bread es realmente un éxito y a todos
        les gusta pero también queríamos tener una opción de chocolate para ofrecer y nos pareció
        que el Avocado fresa brownie iría perfecto ya que es vegano y sin gluten.
      </p>
      <p className="py-2">
      ...
      <p className="py-2">
        Pastel de avocado y fresa brownie: su base es la del brownie de avocado y fresa ( harina de
        coco, avocado, fresa, chocolate dark) este brownie es libre de gluten, vegano, sin azúcar es
        idéntico al que hacemos, solamente que lo cambiamos de manera circular y el doble de alto
        con una decoración de frutos rojos. Este pastel rinde aproximadamente 12 porciones y su peso
        es de 1 kg
      </p>
    </Section>
  );
