...
const KetoSection: FC = () => {
  return (
    <Section id="keto" title="Que es keto?" textColor="black">
      <p className="py-2">
        La dieta cetogénica (Keto) es un plan de alimentación bajo en carbohidratos y alto en grasas
        vinculado con muchos beneficios potenciales para la salud. Seguir una dieta cetogénica no se
        trata sólo de limitar la ingesta de carbohidratos. El objetivo es hacer la transición de
        nuestro cuerpo a un modo de quema de grasa conocido como cetosis. Para hacer esto, la
        mayoría de las calorías deben provenir de las grasas.
      </p>
      <p className="py-2">
      ...
      <p className="py-2">
        ...
        mayoría, esto significa que del 5% al ​​10% de la ingesta energética total puede provenir de
        los carbohidratos.
      </p>
      <p className="py-2">
