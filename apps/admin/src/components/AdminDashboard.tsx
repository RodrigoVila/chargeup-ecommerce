...
export default function AdminDashboard() {
  return (
    <div className='object-center align-center xl:w-full'>
      <main className='px-4 mx-auto mt-10 xl:mt-18 max-w-7xl sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:w-max lg:px-8 xl:w-max'>
        <div className='xl:walign-center sm:text-center lg:text-left xl:object-center'>
          ...
          <div className='xl:align-center xl:object-center'>
            <p className='mt-3 text-base text-gray-500 xl:align-right 2xl:align-right sm:mx-auto sm:mt-5 sm:max-w-xl sm:text-lg md:mt-5 md:text-xl lg:mx-0 xl:object-right '>
