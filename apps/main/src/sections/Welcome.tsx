...
export const WelcomeSection: FC = () => {
  ...
  return (
    <Section id='welcome' bgImage='welcome.jpg' overlay bodyClassName='absolute inset-0 mx-auto'>
      <div className='font-dinBold flex h-full w-full flex-col items-center justify-center gap-4'>
        ...
        <div className='text-md leading-0 flex flex-col items-center justify-center text-center font-semibold text-white md:px-20 md:text-3xl lg:px-56 xl:flex-row xl:px-0'>
