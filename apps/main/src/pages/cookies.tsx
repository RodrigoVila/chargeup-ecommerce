  ...
  return (
    <div style={{ margin: '20px' }}>
      ...
      <p>
        ...
        the help of the{' '}
        <a href='Cookies Policy Generator' target='_blank'>
      ...
      <ul>
        <li>
          ...
          &quot;Us&quot; or &quot;Our&quot; in this Cookies Policy) refers to Charge Up BCN, Calle
          Pamplona 88.
        </li>
        <li>
      ...
      <ul>
        <li>
          <p>
            ...
            <a
              href='Clear cache & cookies - Computer - Google Account Help'
        ...
        <li>
          <p>
            ...
            <a
              href='How to delete cookie files in Internet Explorer'
              rel='external nofollow noopener'
              target='_blank'
            >
        ...
        <li>
          <p>
            ...
            <a
              href='Clear cookies and site data in Firefox | Firefox Help'
              rel='external nofollow noopener'
              target='_blank'
            >
        ...
        <li>
          <p>
            ...
            <a
              href='Manage cookies and website data in Safari on Mac'
              rel='external nofollow noopener'
              target='_blank'
            >
      ...
      <p>
        ...
        <a href='All About Cookies - TermsFeed' target='_blank'>
      ...
      <ul>
        <li>
          <p>By email: chargeupbcn@gmail.com</p>
        </li>
        <li>
          <p>
